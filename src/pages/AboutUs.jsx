...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-50 text-gray-800 px-6 py-12">
      <div className="max-w-6xl mx-auto">

        {/* Heading */}
        <h1 className="text-5xl font-bold text-center text-purple-700 mb-4">About MediQueue Hospital</h1>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <section className="bg-white shadow-lg rounded-xl p-6 md:col-span-2">
            <h2 className="text-2xl font-semibold text-purple-600 mb-3">Our Core Values</h2>
          ...
          {/* Facilities */}
          <section className="bg-white shadow-lg rounded-xl p-6 md:col-span-2">
            <h2 className="text-2xl font-semibold text-purple-600 mb-3">Our Facilities</h2>
          ...
          {/* Trust */}
          <section className="bg-white shadow-lg rounded-xl p-6 md:col-span-2">
            <h2 className="text-2xl font-semibold text-purple-600 mb-3">Trusted By Thousands</h2>
            <p className="text-gray-700 leading-relaxed">
